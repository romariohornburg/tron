...
import { useWebappPods, useDeleteWebappPod, useWebappPodLogs, useWebappPodDescribe, useExecWebappPodCommand } from '../../../features/components'
...
export const useWebappDetail = (organizationUuid: string | undefined, componentUuid: string | undefined, refreshInterval: number) => {
  ...
  const { data: podDescribe, isLoading: isLoadingDescribe } = useWebappPodDescribe(
    organizationUuid,
    componentUuid,
